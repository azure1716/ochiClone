...
const Footer = () => {
  return (
    <div  className='bg-zinc-900 h-screen w-full pt-1 flex gap-[15vw] relative'>
      <div className='mt-[7vh] ml-[5vw] leading-none tracking-tighter'>
        <h1 className='text-white text-[12vh] font-semibold'>EYE-</h1>
        <h1 className='text-white text-[12vh] font-semibold'>OPENING</h1>
      </div>
      <div className='leading-none tracking-tighter mt-[7vh]'>
        <h1 className='text-white text-[12vh] font-semibold'>
            PRESENTATIONS
            <footer class="w-full  px-10 py-16 flex flex-col">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">


      <div className='text-xl'>
        <p class="mb-3 text-xl">S:</p>
      ...
      <div className='text-xl'>
        <p class="mb-3 font-medium">L:</p>
        <ul class="space-y-4 underline">
          <li>
...
<br/>
      ...
      <div className='text-xl'>
        <p class="mb-3 font-medium">E:</p>
        <a href="mailto:hello@ochi.design" class="underline">hello@ochi.design</a>
      </div>

      <br/>
      <div className='text-xl'>
        <p class="mb-3 font-medium">M:</p>
        <ul class="space-y-1 underline">
          <li><a href="#">Home</a></li>
         ...
         <div  className='logo absolute left-[7vw] bottom-[7vh]'>
